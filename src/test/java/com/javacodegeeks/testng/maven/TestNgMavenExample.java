...
public class TestNgMavenExample {
	...
	public void contactspageobjects() throws InterruptedException {
		...
		//ContactsPageObjects.Dontcallcheckbox.click();
		//List check = driver.findElements(By.name("do_not_call"));
		//check.get(0).click();
		/*try {
		WebElement check_box = driver.findElement(By.xpath("//input[@name='do_not_call']"));
		Thread.sleep(10000);
		check_box.click();
		...
		ContactsPageObjects.ImagetxtBox.sendKeys("C://Users//Teju//Pictures//Saved Pictures//FreeCRM.png");
